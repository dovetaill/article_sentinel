...
import (
	...
	domain "github.com/dovetaill/article-sentinel/internal/modules/articleinspect/domain"
)
...
func articleFieldValue(article CandidateArticle, scope string) string {
	switch scope {
	case domain.KeywordScopeTitle:
		return article.Title
	case domain.KeywordScopeShortTitle:
		return article.ShortTitle
	case domain.KeywordScopeRichTitle:
		return article.RichTitle
	case domain.KeywordScopeKeyword:
		return article.Keyword
	case domain.KeywordScopeDesc:
		return article.Desc
	case domain.KeywordScopeBody:
		return article.Body
	default:
		return ""
	}
